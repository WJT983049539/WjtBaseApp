...
import com.privatee.mylibrary.DiskLruTools.DiskLruCache;
import com.privatee.mylibrary.DiskLruTools.DiskLruCacheUtil;
import com.privatee.mylibrary.DiskLruTools.DiskLruCacheUtils;
...
public class DiskLruCacheHelper
{
    ...
    private static DiskLruCache generateCache(Context context, String dirName, int maxCount)
    {
        ...
        try {
            /**
             *  缓存文件夹,app版本 单个节点所对应的数据的个数， 缓存大小
             */
